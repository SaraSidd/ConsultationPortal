                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								$retval = mysqli_query($conn, "Select * from doctor where DeleteStatus=0") or die(mysql_error());
                                    ...
                                    <tr class="odd gradeX">
										...
										<td><?php echo $row2['Rating'];?></td>
                                         ...
                                         <?php
										   ...
										   {
											?>
											   <td><a href= "verify.php?dId=<?php print $dId; ?>&status=<?php print $status; ?>">Not Verified</a></td>
											 
								      <?php }else if($status == 1) 
									  { ?>

                                        	<td><a href= "verify.php?dId=<?php print $dId; ?>&status=<?php print $status; ?>">Verified</a></td>							  
									  <?php } 
										   ...
										   {
											?>
											   <td><a href= "delete.php?dId=<?php print $dId; ?>&delete=<?php print $del; ?>">Delete</a></td>
											 
								      <?php } ?>
									  
									  <td><form action="ratedoc.php" method="post" id="rate">
