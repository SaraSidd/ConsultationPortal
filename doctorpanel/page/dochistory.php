            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i> <?php echo $id." Logged in as  ".$username; ?> </a>
                        </li>
                        <li class="divider"></li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
								<?php
								//$query = "SELECT * FROM prescription pr INNER JOIN patient pa ON pa.PatientId = pr.PatientId ";
								$retval = mysqli_query($conn, "SELECT * FROM prescription pr INNER JOIN patient pa ON pa.PatientId = pr.PatientId where DocId = $id ");
