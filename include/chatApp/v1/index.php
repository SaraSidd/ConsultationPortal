...
$app->post('/send', function () use ($app) {
    ...
    verifyRequiredParams(array('id', 'reciever_id', 'message'));

    //Getting request parameters
    $id = $app->request()->post('id');
    $reciever_id = $app->request()->post('reciever_id');
    ...
    $pushdata['id']=$id;
    //Adding reciever id to identify the user who recieve the message
    $pushdata['reciever_id']=$reciever_id;


    //If message is successfully added to database
    if ($db->addMessage($id, $reciever_id, $message)) {
...
$app->get('/messages', function () use ($app){
    ...
    while($row = mysqli_fetch_array($messages)){
       ...
       // $temp['reciever_id']=$row['reciever_id'];
